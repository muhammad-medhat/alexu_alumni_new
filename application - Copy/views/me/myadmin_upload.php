...
echo form_open_multipart('my_admin/upload_file');?>
  ...
  <tr><td><input type="checkbox" name="one_year">سنة واحدة و ليست من الملف</input></td>
...
<tr>
  <td><input type="checkbox" name="insert">تنفيذ</input></td>
  <td> <?php echo form_submit('upload', 'OK'); ?>
</tr>
